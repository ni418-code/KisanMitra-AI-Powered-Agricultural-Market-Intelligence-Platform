  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-50 text-slate-900">
      ...
      <main className="flex-1">
        <Routes>
          {/* Public & Unified Auth Routes */}
          <Route path="/" element={<LandingPage />} />
          <Route path="/user-select" element={<UserSelectionPage />} />
          ...
          <Route path="/farmer/market-prices/:crop" element={<FarmerCropPriceDetail />} />
          <Route path="/farmer/crops" element={<FarmerMyCrops />} />
          <Route path="/farmer/crops/add" element={<FarmerAddCrop />} />
          <Route path="/farmer/requirements" element={<FarmerRequirements />} />
          <Route path="/farmer/requirements/:id" element={<FarmerRequirementDetail />} />
          ...
          <Route path="/buyer/find-crops" element={<BuyerFindCrops />} />
          <Route path="/buyer/requirements" element={<BuyerRequirements />} />
          <Route path="/buyer/requirements/create" element={<BuyerCreateRequirement />} />
          <Route path="/buyer/requirements/:id" element={<BuyerRequirementDetail />} />
          <Route path="/buyer/orders" element={<BuyerOrders />} />
          <Route path="/buyer/orders/:id" element={<BuyerOrderDetail />} />
          <Route path="/buyer/pickup/:id" element={<BuyerPickupManagement />} />
          <Route path="/buyer/payment/:id" element={<BuyerPayment />} />
      ...
      {/* Mobile Smartphone Bottom Navigation */}
      <MobileBottomNav />
    </div>
  );
};
